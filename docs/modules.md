...
```kotlin
implementation("io.github.erkko68.filament:filament-compose:0.1.3-beta04")
```
...
```kotlin
implementation("io.github.erkko68.filament:filament:0.1.3-beta04")
```
...
```kotlin
implementation("io.github.erkko68.filament:gltfio:0.1.3-beta04")
```
...
```kotlin
implementation("io.github.erkko68.filament:filament-utils:0.1.3-beta04")
```
...
```kotlin
implementation("io.github.erkko68.filament:filamat:0.1.3-beta04")
```
...
All modules share a single version, currently **`0.1.3-beta04`**, tracking Filament **1.72.0** upstream. Always upgrade all `io.github.erkko68.filament:*` artifacts together — mixed versions are not supported.
