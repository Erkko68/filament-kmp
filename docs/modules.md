...
```kotlin
implementation("io.github.erkko68.filament:filament:0.3.1")
```
...
All modules share a single version, currently **`0.3.1`**, tracking Filament **1.74.1** upstream. Always upgrade all `io.github.erkko68.filament:*` artifacts together — mixed versions are not supported.
