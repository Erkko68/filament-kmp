...
```kotlin
implementation("io.github.erkko68.filament:filament:0.2.0")
```
...
```kotlin
implementation("io.github.erkko68.filament:gltfio:0.2.0")
```
...
```kotlin
implementation("io.github.erkko68.filament:filamat:0.2.0")
```
...
All modules share a single version, currently **`0.2.0`**, tracking Filament **1.73.0** upstream. Always upgrade all `io.github.erkko68.filament:*` artifacts together — mixed versions are not supported.
