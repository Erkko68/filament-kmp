...
All modules share a single version, currently **`0.1.3-beta02`**, tracking Filament **1.72.0** upstream. Always upgrade all `io.github.erkko68.filament:*` artifacts together — mixed versions are not supported.
