...
```kotlin
implementation("io.github.erkko68.filament:filament:0.3.0")
```
...
All modules share a single version, currently **`0.3.0`**, tracking Filament **1.74.0** upstream. Always upgrade all `io.github.erkko68.filament:*` artifacts together — mixed versions are not supported.
