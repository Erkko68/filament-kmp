...
```kotlin
implementation("io.github.erkko68.filament:filament:0.1.0-alpha01")
```
...
All modules share a single version, currently **`0.1.0-alpha01`**, tracking Filament **1.71.4** upstream. Always upgrade all `io.github.erkko68.filament:*` artifacts together — mixed versions are not supported.
