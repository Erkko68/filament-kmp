...
```kotlin
implementation("io.github.erkko68.filament:filament:0.1.2-beta06")
```
...
All modules share a single version, currently **`0.1.2-beta06`**, tracking Filament **1.72.0** upstream. Always upgrade all `io.github.erkko68.filament:*` artifacts together — mixed versions are not supported.
