...
All modules share a single version, currently **`0.4.0`**, tracking Filament **1.76.0** upstream. Always upgrade all `io.github.erkko68.filament:*` artifacts together — mixed versions are not supported.
