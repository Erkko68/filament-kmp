...
actual class Manipulator @InternalFilamentApi constructor(internal val nativeHandle: Int) : AutoCloseable {
    ...
    actual class Bookmark @InternalFilamentApi constructor(internal val nativeHandle: Int)
}
