...
/**
 * A MaterialInstance is a spawned instance of a [Material].
 * It allows to set parameters and raster state overrides.
 */
expect class MaterialInstance {

    enum class BooleanElement {
        BOOL,
        BOOL2,
        BOOL3,
        BOOL4
