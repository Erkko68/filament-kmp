...
actual class View internal constructor(internal val nativeView: FilamentView) {
    ...
    actual fun getBlendMode(): BlendMode {
        return dev.filament.kmp.View.BlendMode.values()[this@View.nativeView.blendMode.ordinal]
    }
    ...
    actual fun getDithering(): Dithering {
        return dev.filament.kmp.View.Dithering.values()[this@View.nativeView.dithering.ordinal]
    }
    ...
    actual fun getDynamicResolutionOptions(): DynamicResolutionOptions {
        ...
        kmp.quality = dev.filament.kmp.View.Quality.values()[o.quality.ordinal]
        return kmp
    }
    ...
    actual fun getRenderQuality(): RenderQuality {
        ...
        kmp.hdrColorBuffer = dev.filament.kmp.View.Quality.values()[o.hdrColorBuffer.ordinal]
        return kmp
    }
    ...
    actual fun getBloomOptions(): BloomOptions {
        ...
        kmp.blendMode = dev.filament.kmp.View.BloomOptions.BlendMode.values()[o.blendMode.ordinal]
        kmp.quality = dev.filament.kmp.View.Quality.values()[o.quality.ordinal]
        return kmp
    }
    ...
    actual fun getDepthOfFieldOptions(): DepthOfFieldOptions {
        ...
        kmp.filter = dev.filament.kmp.View.DepthOfFieldOptions.Filter.values()[o.filter.ordinal]
    ...
    actual fun getAmbientOcclusionOptions(): AmbientOcclusionOptions {
        ...
        kmp.quality = dev.filament.kmp.View.Quality.values()[o.quality.ordinal]
        kmp.lowPassFilter = dev.filament.kmp.View.Quality.values()[o.lowPassFilter.ordinal]
        kmp.upsampling = dev.filament.kmp.View.Quality.values()[o.upsampling.ordinal]
        kmp.enabled = o.enabled
        kmp.bentNormals = o.bentNormals
        kmp.resolution = o.resolution
        
        val kmpSsct = dev.filament.kmp.View.AmbientOcclusionOptions.Ssct()
