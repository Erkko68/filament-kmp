...
actual class View internal constructor(internal val nativeView: FilamentView) {
    ...
    actual fun getBlendMode(): BlendMode {
        return io.github.erkko68.View.BlendMode.values()[this@View.nativeView.blendMode.ordinal]
    }
    ...
    actual fun getDithering(): Dithering {
        return io.github.erkko68.View.Dithering.values()[this@View.nativeView.dithering.ordinal]
    }
    ...
    actual fun getDynamicResolutionOptions(): DynamicResolutionOptions {
        ...
        kmp.quality = io.github.erkko68.View.Quality.values()[o.quality.ordinal]
        return kmp
    }
    ...
    actual fun getRenderQuality(): RenderQuality {
        ...
        kmp.hdrColorBuffer = io.github.erkko68.View.Quality.values()[o.hdrColorBuffer.ordinal]
        return kmp
    }
    ...
    actual fun getBloomOptions(): BloomOptions {
        ...
        kmp.blendMode = io.github.erkko68.View.BloomOptions.BlendMode.values()[o.blendMode.ordinal]
        kmp.quality = io.github.erkko68.View.Quality.values()[o.quality.ordinal]
        return kmp
    }
    ...
    actual fun getDepthOfFieldOptions(): DepthOfFieldOptions {
        ...
        kmp.filter = io.github.erkko68.View.DepthOfFieldOptions.Filter.values()[o.filter.ordinal]
    ...
    actual fun getAmbientOcclusionOptions(): AmbientOcclusionOptions {
        ...
        kmp.quality = io.github.erkko68.View.Quality.values()[o.quality.ordinal]
        kmp.lowPassFilter = io.github.erkko68.View.Quality.values()[o.lowPassFilter.ordinal]
        kmp.upsampling = io.github.erkko68.View.Quality.values()[o.upsampling.ordinal]
        kmp.enabled = o.enabled
        kmp.bentNormals = o.bentNormals
        kmp.resolution = o.resolution
        
        val kmpSsct = io.github.erkko68.View.AmbientOcclusionOptions.Ssct()
