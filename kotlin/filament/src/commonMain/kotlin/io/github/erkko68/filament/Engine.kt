...
expect class Engine {
    ...
    class Config() {
        ...
        @PlatformGap(platforms = [FilamentPlatform.WEB], behavior = "tracked locally only — filament.js's Engine.create takes WebGL context attributes, not an Engine::Config.")
