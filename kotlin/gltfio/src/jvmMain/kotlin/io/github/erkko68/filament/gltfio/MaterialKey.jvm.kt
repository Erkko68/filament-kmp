...
internal fun MaterialKey.toNative(a: SegmentAllocator): MemorySegment {
    ...
    FilaMaterialKeyFields.alphaMode(fields, alphaMode.ordinal.toByte())
...
private fun MaterialKey.fromFields(fields: MemorySegment) {
    ...
    alphaMode = AlphaMode.entries[FilaMaterialKeyFields.alphaMode(fields).toInt()]
...
actual fun MaterialKey.constrainMaterial(uvmap: IntArray): Unit = confined { a ->
    val key = toNative(a)
