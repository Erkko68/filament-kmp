    ...
    sourceSets {
        webMain {
            ...
            dependencies {
                ...
                // Pinned to a version Karakum 1.0.0-alpha.107 generates against (see
                // karakum-team/karakum gradle.properties); still-newer wrappers made the
                // TypedArrays generic (Float32Array<B>), which Karakum's output doesn't
                // parameterise.
