...
int main(void) {
    printf("Running engine+view+color_grading+render_target functionality program...\n");
    ...
    printf("Engine+view+color_grading+render_target functionality program completed\n");
    return 0;
}
