...
echo "Building wrapper + progressive compile tests (engine + scene + renderer)..."
...
echo ""
echo "✅ Build successful! Progressive tests for Engine, Scene, and Renderer are in place."
