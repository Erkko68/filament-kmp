...
echo "Building wrapper + progressive compile tests (engine + scene + renderer + view + camera + entity manager + fence + swapchain + transform manager + light manager + renderable manager)..."
...
echo ""
echo "✅ Build successful! Progressive tests for Engine, Scene, Renderer, View, Camera, EntityManager, Fence, SwapChain, TransformManager, LightManager, and RenderableManager are in place."
