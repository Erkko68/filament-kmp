...
void test_headers_gltfio_filament_instance(void) {
    ...
    (void)FilaGltfioFilamentInstance_getAsset((const FilaGltfioFilamentInstance*)0);
    ...
    (void)FilaGltfioFilamentInstance_getInverseBindMatricesAt((const FilaGltfioFilamentInstance*)0, 0u, matrices, 4u);
