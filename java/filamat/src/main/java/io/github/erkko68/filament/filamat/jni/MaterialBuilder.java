...
public class MaterialBuilder {
    ...
    public enum SpecularAmbientOcclusion { NONE, SIMPLE, BENT_NORMALS }
    ...
    public enum SamplerFormat { INT, UINT, FLOAT, SHADOW }

    public enum ParameterPrecision { LOW, MEDIUM, HIGH, DEFAULT }

    public enum Variable { CUSTOM0, CUSTOM1, CUSTOM2, CUSTOM3 }
    ...
    public MaterialBuilder name(@NotNull String name) { nMaterialBuilderName(mNativeBuilder, name); return this; }
    public MaterialBuilder shading(@NotNull Shading shading) { nMaterialBuilderShading(mNativeBuilder, shading.ordinal()); return this; }
    public MaterialBuilder interpolation(@NotNull Interpolation interpolation) { nMaterialBuilderInterpolation(mNativeBuilder, interpolation.ordinal()); return this; }
    public MaterialBuilder blending(@NotNull BlendingMode mode) { nMaterialBuilderBlending(mNativeBuilder, mode.ordinal()); return this; }
    public MaterialBuilder postLightingBlending(@NotNull BlendingMode mode) { nMaterialBuilderPostLightingBlending(mNativeBuilder, mode.ordinal()); return this; }
    public MaterialBuilder materialDomain(@NotNull MaterialDomain domain) { nMaterialBuilderMaterialDomain(mNativeBuilder, domain.ordinal()); return this; }
    public MaterialBuilder vertexDomain(@NotNull VertexDomain domain) { nMaterialBuilderVertexDomain(mNativeBuilder, domain.ordinal()); return this; }
    public MaterialBuilder material(@NotNull String code) { nMaterialBuilderMaterial(mNativeBuilder, code); return this; }
    public MaterialBuilder materialVertex(@NotNull String code) { nMaterialBuilderMaterialVertex(mNativeBuilder, code); return this; }
    public MaterialBuilder targetApi(@NotNull TargetApi api) { nMaterialBuilderTargetApi(mNativeBuilder, api.bit); return this; }
    public MaterialBuilder optimization(@NotNull Optimization optimization) { nMaterialBuilderOptimization(mNativeBuilder, optimization.ordinal()); return this; }
    public MaterialBuilder platform(@NotNull Platform platform) { nMaterialBuilderPlatform(mNativeBuilder, platform.ordinal()); return this; }
    ...
    public MaterialBuilder uniformParameter(@NotNull UniformType type, @NotNull ParameterPrecision precision, @NotNull String name) {
    ...
    public MaterialBuilder uniformParameterArray(@NotNull UniformType type, int size, @NotNull ParameterPrecision precision, @NotNull String name) {
        nMaterialBuilderUniformParameterArray(mNativeBuilder, type.ordinal(), size, precision.ordinal(), name);
        return this;
    }

    public MaterialBuilder samplerParameter(@NotNull SamplerType type, @NotNull SamplerFormat format, @NotNull ParameterPrecision precision, @NotNull String name) {
    ...
    public MaterialBuilder colorWrite(boolean enable) { nMaterialBuilderColorWrite(mNativeBuilder, enable); return this; }
    public MaterialBuilder depthWrite(boolean enable) { nMaterialBuilderDepthWrite(mNativeBuilder, enable); return this; }
    public MaterialBuilder depthCulling(boolean enable) { nMaterialBuilderDepthCulling(mNativeBuilder, enable); return this; }
    public MaterialBuilder doubleSided(boolean doubleSided) { nMaterialBuilderDoubleSided(mNativeBuilder, doubleSided); return this; }
    public MaterialBuilder culling(@NotNull CullingMode mode) { nMaterialBuilderCulling(mNativeBuilder, mode.ordinal()); return this; }
    public MaterialBuilder transparencyMode(@NotNull TransparencyMode mode) { nMaterialBuilderTransparencyMode(mNativeBuilder, mode.ordinal()); return this; }
    public MaterialBuilder maskThreshold(float threshold) { nMaterialBuilderMaskThreshold(mNativeBuilder, threshold); return this; }
    public MaterialBuilder alphaToCoverage(boolean enable) { nMaterialBuilderAlphaToCoverage(mNativeBuilder, enable); return this; }
    public MaterialBuilder shadowMultiplier(boolean enable) { nMaterialBuilderShadowMultiplier(mNativeBuilder, enable); return this; }
    public MaterialBuilder transparentShadow(boolean enable) { nMaterialBuilderTransparentShadow(mNativeBuilder, enable); return this; }
    public MaterialBuilder specularAntiAliasing(boolean enable) { nMaterialBuilderSpecularAntiAliasing(mNativeBuilder, enable); return this; }
    public MaterialBuilder specularAntiAliasingVariance(float variance) { nMaterialBuilderSpecularAntiAliasingVariance(mNativeBuilder, variance); return this; }
    public MaterialBuilder specularAntiAliasingThreshold(float threshold) { nMaterialBuilderSpecularAntiAliasingThreshold(mNativeBuilder, threshold); return this; }
    public MaterialBuilder refractionMode(@NotNull RefractionMode mode) { nMaterialBuilderRefractionMode(mNativeBuilder, mode.ordinal()); return this; }
    public MaterialBuilder reflectionMode(@NotNull ReflectionMode mode) { nMaterialBuilderReflectionMode(mNativeBuilder, mode.ordinal()); return this; }
    public MaterialBuilder refractionType(@NotNull RefractionType type) { nMaterialBuilderRefractionType(mNativeBuilder, type.ordinal()); return this; }
    public MaterialBuilder clearCoatIorChange(boolean enable) { nMaterialBuilderClearCoatIorChange(mNativeBuilder, enable); return this; }
    public MaterialBuilder flipUV(boolean enable) { nMaterialBuilderFlipUV(mNativeBuilder, enable); return this; }
    public MaterialBuilder customSurfaceShading(boolean enable) { nMaterialBuilderCustomSurfaceShading(mNativeBuilder, enable); return this; }
    public MaterialBuilder multiBounceAmbientOcclusion(boolean enable) { nMaterialBuilderMultiBounceAmbientOcclusion(mNativeBuilder, enable); return this; }
    public MaterialBuilder specularAmbientOcclusion(@NotNull SpecularAmbientOcclusion sao) { nMaterialBuilderSpecularAmbientOcclusion(mNativeBuilder, sao.ordinal()); return this; }
    ...
    public MaterialPackage build(@Nullable Engine engine) {
        long jobSystem = 0;
        if (engine != null) {
            // We'll need to add a way to get the native job system from Engine in nBuilderBuild
            // But for now we allow passing engine to find its native counterpart if possible.
        }
    ...
    private static native void nMaterialBuilderUniformParameter(long nativeBuilder, int type, int precision, String name);
    private static native void nMaterialBuilderUniformParameterArray(long nativeBuilder, int type, int size, int precision, String name);
    private static native void nMaterialBuilderSamplerParameter(long nativeBuilder, int type, int format, int precision, String name);
