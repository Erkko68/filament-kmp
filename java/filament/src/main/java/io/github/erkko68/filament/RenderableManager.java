...
import io.github.erkko68.filament.proguard.UsedByNative;
...
public class RenderableManager {
    ...
    public boolean hasComponent(@io.github.erkko68.filament.Entity int entity) { return nHasComponent(mNativeObject, entity); }

    @io.github.erkko68.filament.proguard.EntityInstance
    public int getInstance(@io.github.erkko68.filament.Entity int entity) { return nGetInstance(mNativeObject, entity); }

    public void destroy(@io.github.erkko68.filament.Entity int entity) { nDestroy(mNativeObject, entity); }
    ...
    public static class Builder {
        ...
        public void build(@NotNull Engine engine, @io.github.erkko68.filament.Entity int entity) {
    ...
    public int getEnabledAttributesAt(@io.github.erkko68.filament.proguard.EntityInstance int i, int primitiveIndex) { return nGetEnabledAttributesAt(mNativeObject, i, primitiveIndex); }

    public int getPrimitiveCount(@io.github.erkko68.filament.proguard.EntityInstance int i) { return nGetPrimitiveCount(mNativeObject, i); }

    @io.github.erkko68.filament.proguard.EntityInstance
    public int getInstanceCount(@io.github.erkko68.filament.proguard.EntityInstance int i) { return nGetInstanceCount(mNativeObject, i); }

    public void clearMaterialInstanceAt(@io.github.erkko68.filament.proguard.EntityInstance int i, int primitiveIndex) { nClearMaterialInstanceAt(mNativeObject, i, primitiveIndex); }

    public void setGeometryAt(@io.github.erkko68.filament.proguard.EntityInstance int i, int primitiveIndex, @NotNull PrimitiveType type, @NotNull VertexBuffer vertices, @NotNull IndexBuffer indices, int offset, int count) {
    ...
    public void setGeometryAt(@io.github.erkko68.filament.proguard.EntityInstance int i, int primitiveIndex, @NotNull PrimitiveType type, @NotNull VertexBuffer vertices, @NotNull IndexBuffer indices) {
    ...
    public void setGlobalBlendOrderEnabledAt(@io.github.erkko68.filament.proguard.EntityInstance int instance, int primitiveIndex, boolean enabled) {
        nSetGlobalBlendOrderEnabledAt(mNativeObject, instance, primitiveIndex, enabled);
    }

    public boolean isGlobalBlendOrderEnabledAt(@io.github.erkko68.filament.proguard.EntityInstance int instance, int primitiveIndex) {
        return nIsGlobalBlendOrderEnabledAt(mNativeObject, instance, primitiveIndex);
    }

    public boolean isShadowCaster(@io.github.erkko68.filament.proguard.EntityInstance int i) { return nIsShadowCaster(mNativeObject, i); }

    public boolean isShadowReceiver(@io.github.erkko68.filament.proguard.EntityInstance int i) { return nIsShadowReceiver(mNativeObject, i); }

    public boolean isScreenSpaceContactShadowsEnabled(@io.github.erkko68.filament.proguard.EntityInstance int i) { return nIsScreenSpaceContactShadowsEnabled(mNativeObject, i); }

    @NotNull
    public Box getAxisAlignedBoundingBox(@io.github.erkko68.filament.proguard.EntityInstance int i, @Nullable Box out) {
