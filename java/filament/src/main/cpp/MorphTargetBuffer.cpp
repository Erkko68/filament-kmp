...
Java_io_github_erkko68_filament_MorphTargetBuffer_nCreateBuilder(JNIEnv* env, jclass) {
    return (jlong) new MorphTargetBuffer::Builder();
}

extern "C" JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_MorphTargetBuffer_nDestroyBuilder(JNIEnv* env, jclass, jlong nativeBuilder) {
    delete (MorphTargetBuffer::Builder*) nativeBuilder;
}

extern "C" JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_MorphTargetBuffer_nBuilderVertexCount(JNIEnv* env, jclass, jlong nativeBuilder, jint vertexCount) {
    ((MorphTargetBuffer::Builder*) nativeBuilder)->vertexCount((uint32_t) vertexCount);
}

extern "C" JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_MorphTargetBuffer_nBuilderCount(JNIEnv* env, jclass, jlong nativeBuilder, jint count) {
    ((MorphTargetBuffer::Builder*) nativeBuilder)->count((size_t) count);
}

extern "C" JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_MorphTargetBuffer_nBuilderWithPositions(JNIEnv*, jclass, jlong nativeBuilder, jboolean enabled) {
    ((MorphTargetBuffer::Builder*) nativeBuilder)->withPositions((bool) enabled);
}

extern "C" JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_MorphTargetBuffer_nBuilderWithTangents(JNIEnv*, jclass, jlong nativeBuilder, jboolean enabled) {
    ((MorphTargetBuffer::Builder*) nativeBuilder)->withTangents((bool) enabled);
}

extern "C" JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_MorphTargetBuffer_nBuilderEnableCustomMorphing(JNIEnv*, jclass, jlong nativeBuilder, jboolean enabled) {
    ((MorphTargetBuffer::Builder*) nativeBuilder)->enableCustomMorphing((bool) enabled);
}

extern "C" JNIEXPORT jlong JNICALL
Java_io_github_erkko68_filament_MorphTargetBuffer_nBuilderBuild(JNIEnv* env, jclass, jlong nativeBuilder, jlong nativeEngine) {
...
Java_io_github_erkko68_filament_MorphTargetBuffer_nHasPositions(JNIEnv*, jclass, jlong nativeBuffer) {
    return (jboolean) ((MorphTargetBuffer*) nativeBuffer)->hasPositions();
}

extern "C" JNIEXPORT jboolean JNICALL
Java_io_github_erkko68_filament_MorphTargetBuffer_nHasTangents(JNIEnv*, jclass, jlong nativeBuffer) {
    return (jboolean) ((MorphTargetBuffer*) nativeBuffer)->hasTangents();
}

extern "C" JNIEXPORT jboolean JNICALL
Java_io_github_erkko68_filament_MorphTargetBuffer_nIsCustomMorphingEnabled(JNIEnv*, jclass, jlong nativeBuffer) {
