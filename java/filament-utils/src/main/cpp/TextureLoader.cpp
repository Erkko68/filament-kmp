...
Java_io_github_erkko68_filament_utils_TextureLoader_nLoadTexture(JNIEnv* env, jclass, jlong nativeEngine, jobject javaBuffer, jint remaining, jint type) {
    ...
    if (channels == 3) {
        internalFormat = (type == 0) ? Texture::InternalFormat::SRGB8 : Texture::InternalFormat::RGB8;
        format = Texture::Format::RGB;
    } else {
        internalFormat = (type == 0) ? Texture::InternalFormat::SRGB8_A8 : Texture::InternalFormat::RGBA8;
