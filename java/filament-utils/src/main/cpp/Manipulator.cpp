...
JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nDestroyManipulator(JNIEnv*, jclass, jlong nativeManip) {
    delete (CameraManipulator*) nativeManip;
}

JNIEXPORT jint JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nGetMode(JNIEnv*, jclass, jlong nativeManip) {
    return (jint) ((CameraManipulator*) nativeManip)->getMode();
}

JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nSetViewport(JNIEnv*, jclass, jlong nativeManip, jint width, jint height) {
    ((CameraManipulator*) nativeManip)->setViewport(width, height);
}

JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nGetLookAt(JNIEnv* env, jclass, jlong nativeManip, jfloatArray eyePosition, jfloatArray targetPosition, jfloatArray upward) {
...
JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nRaycast(JNIEnv* env, jclass, jlong nativeManip, jint x, jint y, jfloatArray result) {
...
JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nGrabBegin(JNIEnv*, jclass, jlong nativeManip, jint x, jint y, jboolean strafe) {
    ((CameraManipulator*) nativeManip)->grabBegin(x, y, strafe);
}

JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nGrabUpdate(JNIEnv*, jclass, jlong nativeManip, jint x, jint y) {
    ((CameraManipulator*) nativeManip)->grabUpdate(x, y);
}

JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nGrabEnd(JNIEnv*, jclass, jlong nativeManip) {
    ((CameraManipulator*) nativeManip)->grabEnd();
}

JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nKeyDown(JNIEnv*, jclass, jlong nativeManip, jint key) {
    ((CameraManipulator*) nativeManip)->keyDown((CameraManipulator::Key) key);
}

JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nKeyUp(JNIEnv*, jclass, jlong nativeManip, jint key) {
    ((CameraManipulator*) nativeManip)->keyUp((CameraManipulator::Key) key);
}

JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nScroll(JNIEnv*, jclass, jlong nativeManip, jint x, jint y, jfloat scrolldelta) {
    ((CameraManipulator*) nativeManip)->scroll(x, y, scrolldelta);
}

JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nUpdate(JNIEnv*, jclass, jlong nativeManip, jfloat deltaTime) {
    ((CameraManipulator*) nativeManip)->update(deltaTime);
}

JNIEXPORT jlong JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nGetCurrentBookmark(JNIEnv*, jclass, jlong nativeManip) {
    auto bookmark = ((CameraManipulator*) nativeManip)->getCurrentBookmark();
    return (jlong) new CameraManipulator::Bookmark(bookmark);
}

JNIEXPORT jlong JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nGetHomeBookmark(JNIEnv*, jclass, jlong nativeManip) {
    auto bookmark = ((CameraManipulator*) nativeManip)->getHomeBookmark();
    return (jlong) new CameraManipulator::Bookmark(bookmark);
}

JNIEXPORT void JNICALL
Java_io_github_erkko68_filament_utils_jni_Manipulator_nJumpToBookmark(JNIEnv*, jclass, jlong nativeManip, jlong nativeBookmark) {
