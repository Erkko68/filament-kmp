...
Java_io_github_erkko68_filament_utils_KTX1Loader_nCreateKTXTexture(JNIEnv* env, jclass, jlong nativeEngine, jobject javaBuffer, jint remaining, jboolean srgb) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_io_github_erkko68_filament_utils_KTX1Loader_nCreateIndirectLight(JNIEnv* env, jclass, jlong nativeEngine, jlong nativeTexture, jfloatArray sh) {
    Engine* engine = (Engine*) nativeEngine;
...
extern "C" JNIEXPORT jlong JNICALL
Java_io_github_erkko68_filament_utils_KTX1Loader_nCreateSkybox(JNIEnv* env, jclass, jlong nativeEngine, jlong nativeTexture) {
    Engine* engine = (Engine*) nativeEngine;
    Texture* cubemap = (Texture*) nativeTexture;
...
Java_io_github_erkko68_filament_utils_KTX1Loader_nGetSphericalHarmonics(JNIEnv* env, jclass, jobject javaBuffer, jint remaining, jfloatArray outSh) {
    AutoBuffer buffer(env, javaBuffer, remaining);
